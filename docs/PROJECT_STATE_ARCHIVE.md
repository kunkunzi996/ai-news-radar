...
> 历史状态归档，最新状态见根目录 `PROJECT_STATE.md`。

## 2026-07-15 ~ 2026-08-02 施工状态（2026-08-08 洁癖门归档）

> 以下内容原样出自根目录 `PROJECT_STATE.md`，逐行搬迁未删减。
...
- If MediaCrawler writes a new dated `creator_contents_*.jsonl`, the radar now chooses the newest sibling file automatically; keep the JSONL output in the same platform folder and do not move login/profile artifacts into the radar repo.
...
> 以下两节自根目录 `PROJECT_STATE.md` 迁入，原文照录未作改写。
